...
const TextNode = (props: NodeProps) => {
    ...
    return (
        <div data-selected={props.selected} className="px-4 pb-3 w-52 h-auto shadow-md rounded-lg bg-primary border border-secondary-light data-[selected=true]:border-teal-500 flex flex-col gap-4 transition-all">
